def add_bigram_args(parser):
    ...
    parser.add_argument(
        "--save", default=True, action="store_true", help="whether to save the model"
    )
    parser.add_argument(
        "--portion", type=float, default=1.0, help="portion of negative samples to use"
    )

    # Model Hyperparameters
    parser.add_argument("--loss", type=str, default="margin", help="training loss")
    parser.add_argument(
        "--input_dropout", type=float, default=0.6, help="input_dropout"
    )
    parser.add_argument("--hidden_state", type=int, default=500, help="hidden_state")
    parser.add_argument("--hidden_layers", type=int, default=1, help="hidden_layers")
    parser.add_argument(
        "--hidden_dropout", type=float, default=0.3, help="hidden_dropout"
    )
    ...
    parser.add_argument(
        "--l2_reg_lambda", type=float, default=0.0, help="l2_reg_lambda"
    )
    ...
    parser.add_argument("--note", type=str, default="", help="human readable")
